            ...
            <div className="min-w-screen min-h-screen bg-gray-200 flex items-center justify-center px-5 pb-10 pt-16">
                <div className="w-full mx-auto rounded-lg bg-white shadow-lg p-5 text-gray-700" style={{ maxWidth: '600px' }}>
                    <div className="w-full pt-1 pb-5">
                        <div className="bg-red text-white overflow-hidden rounded-full w-20 h-20 -mt-16 mx-auto shadow-lg flex justify-center items-center">
                            <i className="mdi mdi-credit-card-outline text-3xl"></i>
                        </div>
                    </div>
                    <div className="mb-10">
                        <h1 className="text-md text-center p-4">Paso 3 de 3</h1>
                        <h1 className="text-center font-bold text-2xl uppercase">Pago</h1>
                    </div>
                    ...
                    <div className="mb-3">
                        <label className="font-bold text-sm mb-2 ml-1">Nombre del titular</label>
                        <div>
                    ...
                    <div className="mb-3">
                        <label className="font-bold text-sm mb-2 ml-1">Numero de la tarjet</label>
                        <div>
                    ...
                    <div>
                        <button className="block w-full max-w-xs mx-auto bg-red bg-red-700 hover:bg-red-500 focus:bg-red-600 text-white rounded-lg px-3 py-3 font-semibold"><i className="mdi mdi-lock-outline mr-1"></i> Pagar ahora</button>
                    </div>
                </div>
            </div>
        </>
